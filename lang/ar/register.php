...
return [
    ...
    'google_only_title'       => 'التسجيل حصري عبر حساب Google',
    'google_only_notice'      => 'التسجيل في منصة Medvion يتم حصراً عبر حساب Google لضمان أمان وتوثيق هويتك فورياً.',
    'google_auth_required'    => 'يرجى النقر على زر التسجيل عبر Google أولاً للبدء.',
    'google_verified_badge'   => 'معتمد وموثق عبر Google',
    'google_account_card'     => 'حساب Google المعتمد',
    'google_field_locked'     => 'نص معتمد من Google',
    'google_field_placeholder'=> 'سيتم استيراده واعتماده تلقائياً من Google',
    'google_success_complete_steps' => 'تم التحقق من حسابك عبر Google بنجاح! يُرجى إكمال بقية بياناتك لتفعيل حسابك.',
    'step1_google_sub'        => 'تم استيراد واعتماد بياناتك الأساسية مباشرة من Google دون الحاجة لكلمة مرور.',
    'btn_continue_to_step2'   => 'المتابعة للخطوة 2: بيانات التواصل',
    'switch_account'          => 'تبديل الحساب أو تسجيل الخروج',

    'step1_title'             => 'البيانات الأساسية',
    'step2_title'             => 'العنوان والتواصل',
    'step3_title'             => 'البيانات التعليمية',
    'step2_banner_prompt'     => 'يُرجى إدخال رقم هاتفك ومدينتك للتواصل وتفعيل حسابك.',
    'step3_banner_prompt'     => 'حدد تخصصك ومؤهلك العلمي لإكمال التسجيل بنجاح.',
