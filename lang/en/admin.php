...
return [
    ...
    'login' => [
        'tagline'              => 'The Integrated Healthcare & Medical Training Platform',
        'welcome'              => 'Welcome Back',
        'subtitle'             => 'Sign in to access your Medvion admin panel',
        'submit'               => 'Sign In',
        'security'             => 'Secure & fully protected connection',
        'back_to_site'         => 'Back to Website',
        'copyright'            => '© :year Medvion. All rights reserved.',
        // Platform feature cards (replace stats)
        'feature_1_title'      => 'Accredited Medical Content',
        'feature_1_desc'       => 'Specialised training courses to the highest standards',
        'feature_2_title'      => 'Verified Certificates',
        'feature_2_desc'       => 'Professionally recognised completion certificates',
        'feature_3_title'      => 'Flexible Learning',
        'feature_3_desc'       => 'Instant access anytime, anywhere',
    ],
    'surveys' => [
        'label' => 'Survey',
    ...
    'blogs' => [
        ...
        'sections' => [
            ...
            'content_description' => 'Title, description, and main body of the article',
            'settings' => 'Settings',
            'settings_description' => 'Image, status, and publishing details',
        ],
        'fields' => [
            'title' => 'Title',
            'title_placeholder' => 'Example: Digital Transformation...',
            'short_description' => 'Short Description',
            'short_description_placeholder' => 'Description visible on blog cards...',
            'content' => 'Content',
            'content_placeholder' => 'Write the article content here...',
            'main_image' => 'Main Image',
            'main_image_hint' => 'Max 5MB recommended (will be compressed and scaled down to max 1200px width)',
            'status' => 'Status',
