    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            @foreach($audiences as $audience)
                <div class="px-6 py-4 bg-primary/5 text-primary rounded-xl font-medium border border-primary/10 shadow-sm hover:shadow-md hover:-translate-y-1 transition duration-300 flex items-center">
