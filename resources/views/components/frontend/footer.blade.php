<footer class="bg-primary-dark text-white pt-16 pb-8 mt-16 border-t-[6px] border-secondary relative overflow-hidden">
    @php
        ...
        $twitter = \App\Models\Setting::getSetting('twitter_url', '#');
        $instagram = \App\Models\Setting::getSetting('instagram_url', '#');
        $linkedin = \App\Models\Setting::getSetting('linkedin_url', '#');
    @endphp
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-8 mb-12">
            ...
            <div class="md:col-span-5 lg:col-span-4 flex flex-col items-center md:items-start text-center md:text-start">
                ...
                <div class="flex flex-col gap-4 w-full max-w-xs mx-auto md:mx-0">
                    {{-- Email --}}
                    <a href="mailto:{{ $siteEmail }}" data-index="0" class="footer-link group flex items-center gap-4 bg-white/5 border border-white/10 p-3 rounded-2xl hover:bg-white/10 hover:border-white/20 hover:-translate-y-1 transition-all duration-300 w-full rtl:flex-row-reverse shadow-sm">
                        ...
                        <div class="flex flex-col text-start overflow-hidden">
                            ...
                            <span class="text-sm font-bold font-mono text-white/90 truncate">{{ $siteEmail }}</span>
                        </div>
                    </a>
                    
                    {{-- WhatsApp --}}
                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $whatsapp) }}" target="_blank" data-index="1" class="footer-link group flex items-center gap-4 bg-white/5 border border-white/10 p-3 rounded-2xl hover:bg-white/10 hover:border-white/20 hover:-translate-y-1 transition-all duration-300 w-full rtl:flex-row-reverse shadow-sm">
                        ...
                        <div class="flex flex-col text-start overflow-hidden">
                            ...
                            <span class="text-sm font-bold font-mono text-white/90" dir="ltr">{{ $whatsapp }}</span>
                        </div>
                    </a>

                    {{-- Additional Phone --}}
                    <a href="tel:{{ preg_replace('/[^0-9]/', '', $sitePhone2) }}" data-index="11" class="footer-link group flex items-center gap-4 bg-white/5 border border-white/10 p-3 rounded-2xl hover:bg-white/10 hover:border-white/20 hover:-translate-y-1 transition-all duration-300 w-full rtl:flex-row-reverse shadow-sm">
                        <div class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-white group-hover:bg-primary group-hover:scale-110 group-hover:shadow-lg transition-all duration-300">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                        </div>
                        <div class="flex flex-col text-start overflow-hidden">
                            <span class="text-xs text-white/50 uppercase tracking-widest font-semibold mb-0.5 whitespace-nowrap">{{ __('land.footer_phone_desc') }}</span>
                            <span class="text-sm font-bold font-mono text-white/90 truncate">{{ $sitePhone2 }}</span>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="md:col-span-4 lg:col-span-4 flex flex-col items-center md:items-end justify-center h-full pt-6 md:pt-0">
                ...
                <div class="flex gap-4">
                    {{-- Facebook --}}
                    <a href="{{ $facebook }}" data-index="7" class="footer-link w-12 h-12 rounded-full border border-white/20 bg-white/5 flex items-center justify-center text-white/80 hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] hover:shadow-lg hover:-translate-y-1 transition-all duration-300" aria-label="Facebook">
                    ...
                    {{-- Twitter / X --}}
                    <a href="{{ $twitter }}" data-index="8" class="footer-link w-12 h-12 rounded-full border border-white/20 bg-white/5 flex items-center justify-center text-white/80 hover:text-white hover:bg-black hover:border-black hover:shadow-lg hover:-translate-y-1 transition-all duration-300" aria-label="X (Twitter)">
                    ...
                    {{-- LinkedIn --}}
                    <a href="{{ $linkedin }}" data-index="10" class="footer-link w-12 h-12 rounded-full border border-white/20 bg-white/5 flex items-center justify-center text-white/80 hover:text-white hover:bg-[#0077b5] hover:border-[#0077b5] hover:shadow-lg hover:-translate-y-1 transition-all duration-300" aria-label="LinkedIn">
