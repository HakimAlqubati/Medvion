            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-8 mb-12">
                ...
                <div class="md:col-span-5 lg:col-span-4 flex flex-col items-center md:items-start text-center md:text-start">
                    ...
                    <div class="flex flex-col gap-4 w-full max-w-xs mx-auto md:mx-0">
                        {{-- Email --}}
                        <a href="mailto:hello@medvion.com" class="group flex items-center gap-4 bg-white/5 border border-white/10 p-3 rounded-2xl hover:bg-white/10 hover:border-white/20 hover:-translate-y-1 transition-all duration-300 w-full rtl:flex-row-reverse shadow-sm">
                        ...
                        {{-- WhatsApp --}}
                        <a href="https://wa.me/1234567890" target="_blank" class="group flex items-center gap-4 bg-white/5 border border-white/10 p-3 rounded-2xl hover:bg-white/10 hover:border-white/20 hover:-translate-y-1 transition-all duration-300 w-full rtl:flex-row-reverse shadow-sm">
                ...
                <div class="md:col-span-3 lg:col-span-4 flex flex-col items-center flex-1 justify-center relative">
                    ...
                    <nav class="flex flex-col gap-4 text-sm font-medium text-gray-400 text-center w-max" id="footer-nav">
                        <a href="{{ url('/') }}"       data-index="0" class="footer-link hover:text-secondary hover:translate-x-1 rtl:hover:-translate-x-1 transition-all">{{ __('land.nav_home') }}</a>
                        <a href="{{ url('/#about') }}"  data-index="1" class="footer-link hover:text-secondary hover:translate-x-1 rtl:hover:-translate-x-1 transition-all">{{ __('land.nav_about') }}</a>
                        <a href="{{ url('/#courses') }}" data-index="2" class="footer-link hover:text-secondary hover:translate-x-1 rtl:hover:-translate-x-1 transition-all">{{ __('land.nav_courses') }}</a>
                        <a href="{{ route('privacy') }}" data-index="3" class="footer-link hover:text-secondary hover:translate-x-1 rtl:hover:-translate-x-1 transition-all">{{ __('land.nav_privacy') }}</a>
                        <a href="{{ route('terms') }}"   data-index="4" class="footer-link hover:text-secondary hover:translate-x-1 rtl:hover:-translate-x-1 transition-all">{{ __('land.nav_terms') }}</a>
                    </nav>
                </div>
                ...
                <div class="md:col-span-4 lg:col-span-4 flex flex-col items-center md:items-end justify-center h-full pt-6 md:pt-0">
                    ...
                    <div class="flex gap-4">
                        {{-- Facebook --}}
                        <a href="#" class="w-12 h-12 rounded-full border border-white/20 bg-white/5 flex items-center justify-center text-white/80 hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] hover:shadow-lg hover:-translate-y-1 transition-all duration-300" aria-label="Facebook">
                        ...
                        {{-- Twitter / X --}}
                        <a href="#" class="w-12 h-12 rounded-full border border-white/20 bg-white/5 flex items-center justify-center text-white/80 hover:text-white hover:bg-black hover:border-black hover:shadow-lg hover:-translate-y-1 transition-all duration-300" aria-label="X (Twitter)">
                        ...
                        {{-- LinkedIn --}}
                        <a href="#" class="w-12 h-12 rounded-full border border-white/20 bg-white/5 flex items-center justify-center text-white/80 hover:text-white hover:bg-[#0077b5] hover:border-[#0077b5] hover:shadow-lg hover:-translate-y-1 transition-all duration-300" aria-label="LinkedIn">
