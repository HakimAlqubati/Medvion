...
<style>
    ...
    .mv-logo-ring {
        ...
        box-shadow: 0 10px 35px rgba(0,0,0,0.2), 0 0 50px rgba(26,82,206,0.3);
        animation: logoGlow 4s ease-in-out infinite;
        padding: 12px;
    }
    @keyframes logoGlow {
        0%, 100% { box-shadow: 0 10px 35px rgba(0,0,0,0.2), 0 0 40px rgba(26,82,206,0.35); }
        50%       { box-shadow: 0 12px 45px rgba(0,0,0,0.25), 0 0 70px rgba(20,184,166,0.45); }
    }
