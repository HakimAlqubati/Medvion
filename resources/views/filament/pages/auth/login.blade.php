...
<style>
    ...
    /* ── Force the simple layout to be full-width ── */
    .fi-simple-main-ctn {
        padding: 0 !important;
    ...
    .mv-sv {
        ...
        color: var(--mv-cyan); display: block;
    }
    ...
    /* Submit button (Filament v5 class names) */
...
<div class="mv-wrap">
    ...
    <div class="mv-visual">
        ...
        <div class="mv-vc">
            ...
            <p class="mv-vtag">منصة التكوين الطبي المتكاملة<br>للكوادر الصحية الاحترافية</p>

            <div class="mv-stats">
                <div class="mv-stat">
                    <span class="mv-sv">+200</span>
                    <div class="mv-sl">دورة تدريبية</div>
                </div>
                <div class="mv-stat">
                    <span class="mv-sv">+5K</span>
                    <div class="mv-sl">متدرب</div>
                </div>
                <div class="mv-stat">
                    <span class="mv-sv">98%</span>
                    <div class="mv-sl">رضا المستخدمين</div>
                </div>
            </div>
    ...
    <div class="mv-fp">
        <div class="mv-fi-inner">
            ...
            {{-- Heading --}}
            <h2 class="mv-h2">مرحباً بعودتك 👋</h2>
            <p class="mv-sub">سجّل دخولك للوصول إلى لوحة تحكم Medvion</p>

            {{-- Filament form (with proper Livewire wiring via $this->content) --}}
            {{ $this->content }}
            ...
            <div class="mv-badge">
                ...
                <span>اتصال آمن ومشفر — SSL/TLS 256-bit</span>
            </div>

            {{-- Footer --}}
            <div class="mv-foot">
                <a href="{{ url('/') }}">← العودة إلى الموقع الرئيسي</a>
                <div style="margin-top:0.6rem;">© {{ date('Y') }} Medvion. جميع الحقوق محفوظة.</div>
            </div>
